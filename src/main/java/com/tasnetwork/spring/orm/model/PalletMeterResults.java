...
@Table(name = "PalletResults")
public class PalletMeterResults {
...
/*	@Column( columnDefinition = "VARCHAR(3)" , nullable = false) 
	...
	@Transient
	private SimpleStringProperty  meterHardwareIdProperty = new SimpleStringProperty ();
	...
	public SimpleStringProperty getMeterHardwareIdProperty() {
		meterHardwareIdProperty.set(meterHardwareId);
		return this.meterHardwareIdProperty;
	}
