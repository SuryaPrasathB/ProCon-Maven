...
/*			String payLoadInHex="912345670D0A";
			...
			//ApplicationLauncher.logger.debug("dutMsngrSendCommandProcessV2-X : isDutSerialStatusConnected: "+ getDutMessenger().getDutCmdSpmObj().isDutSerialStatusConnected());
			DutResponse dutResponse = getDutMessenger().dutMsngrSendCommandProcessV2( dutPositionNo,dutCommand, sourceThread);
/*		}else {
