...
public class TextBoxDialog implements Initializable {
		...
		public void run() {
			...
			try {
				...
				ApplicationLauncher.logger
						.error("TextDialogBoxPlatFormRunnable :InterruptedException:" + ex.getMessage());
			}
	...
	class InfoTextDialogBoxPlatFormRunnable implements Runnable {
		...
		public void run() {
			...
			try {
				...
				ex.printStackTrace();
				ApplicationLauncher.logger
						.error("InfoTextDialogBoxPlatFormRunnable :InterruptedException:" + ex.getMessage());
			}
	...
	public void MeterReadingPopup() {
		...
		FXMLLoader loader = new FXMLLoader(
				getClass().getResource("/fxml/deployment/MeterReadingPopup" + ConstantApp.THEME_FXML));
		if (ProcalFeatureEnable.TOTAL_NO_OF_SUPPORTED_RACK == 48) {
			...
			loader = new FXMLLoader(
					getClass().getResource("/fxml/deployment/MeterReadingPopup48" + ConstantApp.THEME_FXML));
			...
			loader = new FXMLLoader(
					getClass().getResource("/fxml/deployment/MeterReadingPopup40" + ConstantApp.THEME_FXML));
			...
			loader = new FXMLLoader(
					getClass().getResource("/fxml/deployment/MeterReadingPopup20" + ConstantApp.THEME_FXML));
			...
			loader = new FXMLLoader(
					getClass().getResource("/fxml/deployment/MeterReadingPopup12" + ConstantApp.THEME_FXML));
		}
		Scene newScene;
		try {
