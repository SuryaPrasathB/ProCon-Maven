...
/*	public  boolean dut0ComSerialStatusConnected = false;
	...
	public  ArrayList<Boolean> comSerialStatusConnectedList = new ArrayList<Boolean>(/*Arrays.asList(
	...
	/*public  SerialPortManagerDutCmd_V3 dut0_Spm = new SerialPortManagerDutCmd_V3(this);///not used, just keeping for index
	public  SerialPortManagerDutCmd_V3 dut1_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut2_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut3_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut4_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut5_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut6_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut7_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut8_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut9_Spm = new SerialPortManagerDutCmd_V3(this);
	
	public  SerialPortManagerDutCmd_V3 dut10_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut11_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut12_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut13_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut14_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut15_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut16_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut17_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut18_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut19_Spm = new SerialPortManagerDutCmd_V3(this);
	
	public  SerialPortManagerDutCmd_V3 dut20_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut21_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut22_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut23_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut24_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut25_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut26_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut27_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut28_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut29_Spm = new SerialPortManagerDutCmd_V3(this);
	
	public  SerialPortManagerDutCmd_V3 dut30_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut31_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut32_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut33_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut34_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut35_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut36_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut37_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut38_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut39_Spm = new SerialPortManagerDutCmd_V3(this);
	
	public  SerialPortManagerDutCmd_V3 dut40_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut41_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut42_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut43_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut44_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut45_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut46_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut47_Spm = new SerialPortManagerDutCmd_V3(this);
	public  SerialPortManagerDutCmd_V3 dut48_Spm = new SerialPortManagerDutCmd_V3(this);*/
	//public  SerialPortManagerDutCmd_V3 dut9_Spm = new SerialPortManagerDutCmd_V3();
	
	public  List<SerialPortManagerDutCmd_V3> dutSpmList = new ArrayList<SerialPortManagerDutCmd_V3>(/*Arrays.asList(
			
			dut0_Spm,///not used, just keeping for index
			dut1_Spm,dut2_Spm,dut3_Spm,dut4_Spm,dut5_Spm,dut6_Spm,dut7_Spm,dut8_Spm,dut9_Spm,dut10_Spm,
			dut11_Spm,dut12_Spm,dut13_Spm,dut14_Spm,dut15_Spm,dut16_Spm,dut17_Spm,dut18_Spm,dut19_Spm,dut20_Spm,
			dut21_Spm,dut22_Spm,dut23_Spm,dut24_Spm,dut25_Spm,dut26_Spm,dut27_Spm,dut28_Spm,dut29_Spm,dut30_Spm,
			dut31_Spm,dut32_Spm,dut33_Spm,dut34_Spm,dut35_Spm,dut36_Spm,dut37_Spm,dut38_Spm,dut39_Spm,dut40_Spm,
			dut41_Spm,dut42_Spm,dut43_Spm,dut44_Spm,dut45_Spm,dut46_Spm,dut47_Spm,dut48_Spm
	...
	public DutResponse dutCmdSerialPortAccessible(String deviceId, int dutPositionNo){
		ApplicationLauncher.logger.debug("dutCmdSerialPortAccessible: dutPositionNo: " +  dutPositionNo +  " -> deviceId: " + deviceId);
		...
		try{
				...
				//status = displayDataObj.pwrSrcPortAccessible_V2_1(dutCmdCommPortID,dutCmdCommBaudRate);
				//BayUtils bayUtils = new BayUtils();
			Optional<DeviceSetting> deviceSettingOpt = MySqlServiceManager.getDeviceSettingService().findByDeviceIdAndPositionNo(deviceId,String.valueOf(dutPositionNo));
			...
			if(deviceSettingOpt.isPresent()) {
				...
				ApplicationLauncher.logger.debug("dutCmdSerialPortAccessible: failed for database mapping : deviceId: "+  deviceId + ", dutPositionNo: " +dutPositionNo );
	...
	public DutResponse  dutCmdPortAccessible_V2_1(int dutPositionId,String selectedComPortId,
		...
		//ApplicationHomeController.update_left_status("DutCmd COM port access validation",ConstantApp.LEFT_STATUS_DEBUG);
		...
		if(dutResponse.getStatus() ) {	
			...
			ApplicationLauncher.logger.info("dutCmdPortAccessible_V2_1: " + ErrorCodeMapping.ERROR_CODE_902 +": "+ErrorCodeMapping.ERROR_CODE_902_MSG);
...
/*		String selectedComPortId = "com14";
		...
		//boolean status = 
		DutResponse dutResponse = dutSpmList.get(dutPositionId).dutComInitV2(selectedComPortId,selectedBaudRate);//HVCI_CommPortID, HVCI_CommBaudRate);
		return dutResponse;
	}
