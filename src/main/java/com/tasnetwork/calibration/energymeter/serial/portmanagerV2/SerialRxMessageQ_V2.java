...
/*
	...
	public void addMsgQueue(String inputMessage) {
		...
		//ApplicationLauncher.logger.info("SerialRxMessageQ V2: inputMessage: "+inputMessage);
		//ApplicationLauncher.logger.info("SerialRxMessageQ V2: inputMessage-String: "+GuiUtils.asciiToHex(inputMessage));
	...
	public void ProcessRxMsg() {
		...
		if(lastMessage != null) {
			...
			ApplicationLauncher.logger.debug("ProcessRxMsg: getExpectedResult hex :"+ GuiUtils.asciiToHex(serialPortObj.getExpectedResult()));
		...
		//ApplicationLauncher.logger.debug("ProcessRxMsg: Exit : ExpectedResponseRecieved:" + ExpectedResponseRecieved);
	}
