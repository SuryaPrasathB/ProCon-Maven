...
public class ReportTestFilterListFilterActiveCheckBoxValueFactory implements Callback<TableColumn.CellDataFeatures<ReportProfileTestDataFilter, CheckBox>, ObservableValue<CheckBox>> {
	...
	public ObservableValue<CheckBox> call(CellDataFeatures<ReportProfileTestDataFilter, CheckBox> param) {
		...
		// setGraphic(checkBox);
		checkBox.selectedProperty().setValue(rowData.isFilterActive());
		checkBox.selectedProperty().addListener((ov, old_val, new_val) -> {
			rowData.setFilterActive(new_val);
		});
