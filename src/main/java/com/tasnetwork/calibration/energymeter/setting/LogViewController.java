...
public class LogViewController implements Initializable {
	...
	public static void updateListOfLogFolders(String[] logfolders) {
		 ...
		 * logfolders);//Collections.singletonList(value1)
	...
	public static void updateViewLogContentSuccess(String logview_content) {
		...
		Platform.runLater(() -> {
			...
			// ApplicationLauncher.logger.info("updateViewLogContent:
			// logContent:"+logContent);
			WindowManager.InformUser("Success", "Log content retrieval success", AlertType.INFORMATION);
		});
		/*
	...
	public static void updateViewLogContentFailure() {
		...
		Platform.runLater(() -> {
			...
			ApplicationLauncher.logger
					.info("updateViewLogContentFailure: Error-808: Unable to retrieve the logs. kindly retry");
			WindowManager.InformUser("Error - 808", "Error-808: Unable to retrieve the logs. kindly retry",
					AlertType.ERROR);
		});
