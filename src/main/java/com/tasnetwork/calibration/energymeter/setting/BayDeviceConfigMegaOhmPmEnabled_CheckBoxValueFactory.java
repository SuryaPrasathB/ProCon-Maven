...
public class BayDeviceConfigMegaOhmPmEnabled_CheckBoxValueFactory implements Callback<TableColumn.CellDataFeatures<BayDeviceConfig, CheckBox>, ObservableValue<CheckBox>> {
	    ...
	    public ObservableValue<CheckBox> call(CellDataFeatures<BayDeviceConfig, CheckBox> param) {
	        ...
	        checkBox.selectedProperty().setValue(rowData.isMegaOhmPmDeviceEnabled());
	        
	        checkBox.selectedProperty().addListener((ov, old_val, new_val) -> {
	        	rowData.setMegaOhmPmDeviceEnabled(new_val);
	        });
