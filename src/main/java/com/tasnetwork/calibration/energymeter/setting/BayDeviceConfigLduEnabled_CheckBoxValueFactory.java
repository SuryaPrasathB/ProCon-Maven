...
public class BayDeviceConfigLduEnabled_CheckBoxValueFactory implements Callback<TableColumn.CellDataFeatures<BayDeviceConfig, CheckBox>, ObservableValue<CheckBox>> {
	    ...
	    public ObservableValue<CheckBox> call(CellDataFeatures<BayDeviceConfig, CheckBox> param) {
	        ...
	        checkBox.selectedProperty().setValue(rowData.isLduDeviceEnabled());
	        
	        checkBox.selectedProperty().addListener((ov, old_val, new_val) -> {
	        	rowData.setLduDeviceEnabled(new_val);
	        });
