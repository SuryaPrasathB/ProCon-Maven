		...
		try {
			...
			Platform.runLater(() -> {
				try{
					...
					//stability_childpane.getChildren().add(getNodeFromFXML("/fxml/setting/DevicePortSetup" + ConstantApp.THEME_FXML));
					//dut_conveyor_childpane.getChildren().add(getNodeFromFXML("/fxml/setting/DutPortSetup" + ConstantApp.THEME_FXML));
					dut_conveyor_childpane.getChildren().add(getNodeFromFXML("/fxml/setting/DutPortSetupV2" + ConstantApp.THEME_FXML));
					//InitCounter--;
			...
			Platform.runLater(() -> {
				try{
					...
					//stability_childpane.getChildren().add(getNodeFromFXML("/fxml/setting/DevicePortSetup" + ConstantApp.THEME_FXML));
					serverSettingChildPane.getChildren().add(getNodeFromFXML("/fxml/setting/ServerSetting" + ConstantApp.THEME_FXML));
					//InitCounter--;
			...
			Platform.runLater(() -> {
				try{
					...
					//stability_childpane.getChildren().add(getNodeFromFXML("/fxml/setting/DevicePortSetup" + ConstantApp.THEME_FXML));
					firmwareUpgradeChildpane.getChildren().add(getNodeFromFXML("/fxml/setting/FirmwareUpgrade" + ConstantApp.THEME_FXML));
					//InitCounter--;
			...
			Platform.runLater(() -> {
				try{
					...
					//stability_childpane.getChildren().add(getNodeFromFXML("/fxml/setting/DevicePortSetup" + ConstantApp.THEME_FXML));
					megaohmmeter_childpane.getChildren().add(getNodeFromFXML("/fxml/setting/MegaOhmPmPortSetupV2" + ConstantApp.THEME_FXML));
					//InitCounter--;

				} catch (Exception e){
					e.printStackTrace();
					ApplicationLauncher.logger.error("LoadAllChild_FXML: MegaOhmPmPortSetup Exception:" + e.getMessage());
				}
			});
			...
			Platform.runLater(() -> {
				try{
					...
					//stability_childpane.getChildren().add(getNodeFromFXML("/fxml/setting/DevicePortSetup" + ConstantApp.THEME_FXML));
					//voltmeter_childpane.getChildren().add(getNodeFromFXML("/fxml/setting/MegaOhmPanelMeterPortSetup" + ConstantApp.THEME_FXML));
					voltmeter_childpane.getChildren().add(getNodeFromFXML("/fxml/setting/VoltPmPortSetupV2" + ConstantApp.THEME_FXML));
					//InitCounter--;
			...
			Platform.runLater(() -> {
				try{
					...
					ldu_childpane.getChildren().add(getNodeFromFXML("/fxml/setting/LduPortSetupV2" + ConstantApp.THEME_FXML));
					//InitCounter--;
			...
			Platform.runLater(() -> {
				try{
					...
					terminalProfileSettingChildPane.getChildren().add(getNodeFromFXML("/fxml/setting/TerminalProfileSetting" + ConstantApp.THEME_FXML));
					//InitCounter--;

				} catch (Exception e){
					e.printStackTrace();
					ApplicationLauncher.logger.error("LoadAllChild_FXML: TerminalProfileSetting Exception:" + e.getMessage());
				}
			});
			...
			Platform.runLater(() -> {
				try{
					...
					bayDeviceConfigChildPane.getChildren().add(getNodeFromFXML("/fxml/setting/BayDeviceConfig" + ConstantApp.THEME_FXML));
					//InitCounter--;
			...
			Platform.runLater(() -> {
				try{
					...
					//qrScanner_childpane.getChildren().add(getNodeFromFXML("/fxml/setting/QrScannerPortSetup" + ConstantApp.THEME_FXML));
					qrScanner_childpane.getChildren().add(getNodeFromFXML("/fxml/setting/QrScannerPortSetupV2" + ConstantApp.THEME_FXML));
					//InitCounter--;

				} catch (Exception e){
					e.printStackTrace();
					ApplicationLauncher.logger.error("LoadAllChild_FXML: QrScannerPortSetup Exception:" + e.getMessage());
				}
			});
