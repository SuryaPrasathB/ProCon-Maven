...
public class SpmLdu {
	...
	private String myTraceName = "Ldu";
	public SpmLdu(String traceName){
	...
	public SpmLdu(String traceName, boolean terminatorMandatory){
		setMyTraceName(traceName);
	...
	public SpmLdu(String traceName, int expectedResponseHexLength){
		setMyTraceName(traceName);
		boolean validateByRxDataLength  = true;
		ApplicationLauncher.logger.debug("SerialPortManagerPwrSrc_V2 : expectedResponseHexLength: " + expectedResponseHexLength);
	...
	{
		ApplicationLauncher.logger.debug("SpmLdu: createObjects :Entry");
...
/*		commLDU = new Communicator(ConstantApp.SERIAL_PORT_LDU);
		...
		ApplicationLauncher.logger.debug("SpmLdu: createObjects :Exit");
	...
	public void startSerialRxPhysical_Ldu() {
	...
	public void enableSerialRxPhysical_LduMonitor() {
