...
/*			TP_ID_Map.put("DFLT-1.0-Import", "001");
			...
			TP_ID_Map.put("VUNB-R:1.0-NmleImport", "216");
			TP_ID_Map.put("VUNB-R:0.5L-NmleImport", "217");
			TP_ID_Map.put("VUNB-R:0.5C-NmleImport", "218");
			TP_ID_Map.put("VUNB-R:0.866L-NmleImport", "219");
			TP_ID_Map.put("VUNB-R:0.866C-NmleImport", "220");
			TP_ID_Map.put("VUNB-Y:1.0-NmleImport", "221");
			TP_ID_Map.put("VUNB-Y:0.5L-NmleImport", "222");
			TP_ID_Map.put("VUNB-Y:0.5C-NmleImport", "223");
			TP_ID_Map.put("VUNB-Y:0.866L-NmleImport", "224");
			TP_ID_Map.put("VUNB-Y:0.866C-NmleImport", "225");
			TP_ID_Map.put("VUNB-B:1.0-NmleImport", "226");
			TP_ID_Map.put("VUNB-B:0.5L-NmleImport", "227");
			TP_ID_Map.put("VUNB-B:0.5C-NmleImport", "228");
			TP_ID_Map.put("VUNB-B:0.866L-NmleImport", "229");
			TP_ID_Map.put("VUNB-B:0.866C-NmleImport", "230");
			TP_ID_Map.put("VUNB-RY:1.0-NmleImport", "231");
			TP_ID_Map.put("VUNB-RY:0.5L-NmleImport", "232");
			TP_ID_Map.put("VUNB-RY:0.5C-NmleImport", "233");
			TP_ID_Map.put("VUNB-RY:0.866L-NmleImport", "234");
			TP_ID_Map.put("VUNB-RY:0.866C-NmleImport", "235");
			TP_ID_Map.put("VUNB-RB:1.0-NmleImport", "236");
			TP_ID_Map.put("VUNB-RB:0.5L-NmleImport", "237");
			TP_ID_Map.put("VUNB-RB:0.5C-NmleImport", "238");
			TP_ID_Map.put("VUNB-RB:0.866L-NmleImport", "239");
			TP_ID_Map.put("VUNB-RB:0.866C-NmleImport", "240");
			TP_ID_Map.put("VUNB-YB:1.0-NmleImport", "241");
			TP_ID_Map.put("VUNB-YB:0.5L-NmleImport", "242");
			TP_ID_Map.put("VUNB-YB:0.5C-NmleImport", "243");
			TP_ID_Map.put("VUNB-YB:0.866L-NmleImport", "244");
			TP_ID_Map.put("VUNB-YB:0.866C-NmleImport", "245");
			...
			TP_ID_Map.put("CUNB-R:1.0-NmleExport", "261");
			TP_ID_Map.put("CUNB-R:0.5L-NmleExport", "262");
			TP_ID_Map.put("CUNB-R:0.5C-NmleExport", "263");
			TP_ID_Map.put("CUNB-R:0.866L-NmleExport", "264");
			TP_ID_Map.put("CUNB-R:0.866C-NmleExport", "265");
			TP_ID_Map.put("CUNB-Y:1.0-NmleExport", "266");
			TP_ID_Map.put("CUNB-Y:0.5L-NmleExport", "267");
			TP_ID_Map.put("CUNB-Y:0.5C-NmleExport", "268");
			TP_ID_Map.put("CUNB-Y:0.866L-NmleExport", "269");
			TP_ID_Map.put("CUNB-Y:0.866C-NmleExport", "270");
			TP_ID_Map.put("CUNB-B:1.0-NmleExport", "271");
			TP_ID_Map.put("CUNB-B:0.5L-NmleExport", "272");
			TP_ID_Map.put("CUNB-B:0.5C-NmleExport", "273");
			TP_ID_Map.put("CUNB-B:0.866L-NmleExport", "274");
			TP_ID_Map.put("CUNB-B:0.866C-NmleExport", "275");
			TP_ID_Map.put("CUNB-RY:1.0-NmleExport", "276");
			TP_ID_Map.put("CUNB-RY:0.5L-NmleExport", "277");
			TP_ID_Map.put("CUNB-RY:0.5C-NmleExport", "278");
			TP_ID_Map.put("CUNB-RY:0.866L-NmleExport", "279");
			TP_ID_Map.put("CUNB-RY:0.866C-NmleExport", "280");
			TP_ID_Map.put("CUNB-RB:1.0-NmleExport", "281");
			TP_ID_Map.put("CUNB-RB:0.5L-NmleExport", "282");
			TP_ID_Map.put("CUNB-RB:0.5C-NmleExport", "283");
			TP_ID_Map.put("CUNB-RB:0.866L-NmleExport", "284");
			TP_ID_Map.put("CUNB-RB:0.866C-NmleExport", "285");
			TP_ID_Map.put("CUNB-YB:1.0-NmleExport", "286");
			TP_ID_Map.put("CUNB-YB:0.5L-NmleExport", "287");
			TP_ID_Map.put("CUNB-YB:0.5C-NmleExport", "288");
			TP_ID_Map.put("CUNB-YB:0.866L-NmleExport", "289");
			TP_ID_Map.put("CUNB-YB:0.866C-NmleExport", "290");
...
/*			TP_ID_Map.put("NDIST-DiodeFwdNLE", "330");
			TP_ID_Map.put("NDIST-DiodeRevNLE", "331");*/
	...
	public static String getTestPoint_ID(String inputTestPoint_Name) {
		...
		try {
			...
			if(TP_ID_Map.has(AliasID_StrippedTestPoint_Name)) {
				ApplicationLauncher.logger.debug("TP_ID_MapInit : TP_Name: " + TP_ID_Map.getString(AliasID_StrippedTestPoint_Name));
