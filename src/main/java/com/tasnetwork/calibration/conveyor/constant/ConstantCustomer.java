...
public class ConstantCustomer implements Initializable {
	...
	public static CustomerManager LAndT_Mysore = new CustomerManager("L & T Mysore", "Procal",
			ConstantProTamp.DEVICE_NAME_LS_PROTAMP_3PHASE);
	...
	public static void init() {
		...
		ApplicationLauncher.logger
				.info("ConstantCustomer: CurrentCustomer Name: " + getCurrentCustomer().getCustomerName());
	}
	...
	public static void LAndT_MysoreData() {
		...
		// LAndT_MysoreUpDatedVersion(buildVersion,releasedDate
		// ,dbSchemaVersion,configVersion,NoOfRacks,ImportMode,ExportMode)
