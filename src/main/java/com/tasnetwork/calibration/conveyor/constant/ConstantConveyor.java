...
public class ConstantConveyor {
	...
	public static final String REASON_RESULT_BATCH_FAILED = REASON_RESULT_BATCH_FAILED_DISPLAY_HEADER
			+ REASON_RESULT_APPENDER + REASON_RESULT_BATCH_REASON;
	...
	public static final int PHASE_CALIB_WAIT_TIME = 55; // in seconds
	public static final int NEUTRAL_CALIB_WAIT_TIME = 35; // in seconds
	...
	// public static final String READ_PHASE_CURRENT_RESULT_TEST_NAME =
	// "ReadPhaseCurrent";
	// public static final String READ_NEUTRAL_CURRENT_RESULT_TEST_NAME =
	// "ReadNeutralCurrent";
	...
	// public static final String DUT_SERIAL_NO_READ_CMD_RESULT_TEST_NAME =
	// "Dut-SNo-ReadCmd";
	...
	public static final ArrayList<Integer> VERIFIC_PALLET2_POSITIONS = new ArrayList<>(
			Arrays.asList(7, 8, 9, 10, 11, 12));
	public static final ArrayList<Integer> VERIFIC_PALLET3_POSITIONS = new ArrayList<>(
			Arrays.asList(13, 14, 15, 16, 17, 18));
	public static final ArrayList<Integer> VERIFIC_PALLET4_POSITIONS = new ArrayList<>(
			Arrays.asList(19, 20, 21, 22, 23, 24));

	public static final ArrayList<Integer> STA_NLD1_PALLET1_POSITIONS = new ArrayList<>(
			Arrays.asList(1, 2, 3, 4, 5, 6));
	public static final ArrayList<Integer> STA_NLD1_PALLET2_POSITIONS = new ArrayList<>(
			Arrays.asList(7, 8, 9, 10, 11, 12));
	public static final ArrayList<Integer> STA_NLD1_PALLET3_POSITIONS = new ArrayList<>(
			Arrays.asList(13, 14, 15, 16, 17, 18));
	public static final ArrayList<Integer> STA_NLD1_PALLET4_POSITIONS = new ArrayList<>(
			Arrays.asList(19, 20, 21, 22, 23, 24));

	public static final ArrayList<Integer> STA_NLD2_PALLET1_POSITIONS = new ArrayList<>(
			Arrays.asList(1, 2, 3, 4, 5, 6));
	public static final ArrayList<Integer> STA_NLD2_PALLET2_POSITIONS = new ArrayList<>(
			Arrays.asList(7, 8, 9, 10, 11, 12));
	public static final ArrayList<Integer> STA_NLD2_PALLET3_POSITIONS = new ArrayList<>(
			Arrays.asList(13, 14, 15, 16, 17, 18));
	public static final ArrayList<Integer> STA_NLD2_PALLET4_POSITIONS = new ArrayList<>(
			Arrays.asList(19, 20, 21, 22, 23, 24));
