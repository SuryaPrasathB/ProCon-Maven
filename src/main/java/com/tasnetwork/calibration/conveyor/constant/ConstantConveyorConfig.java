...
public class ConstantConveyorConfig {
	...
	public static int WAITING_TO_VERIFIC_BAY_PALLET_MOVEMENT_WAIT_TIME_IN_SEC = 10;
	public static int VERIFIC_TO_STA1_BAY_PALLET_MOVEMENT_WAIT_TIME_IN_SEC = 40;
	public static int VERIFIC_TO_STA2_BAY_PALLET_MOVEMENT_WAIT_TIME_IN_SEC = 50;
	public static int STA1_TO_UNLOADING_BAY_PALLET_MOVEMENT_WAIT_TIME_IN_SEC = 120;
	public static int STA2_TO_UNLOADING_BAY_PALLET_MOVEMENT_WAIT_TIME_IN_SEC = 90;
