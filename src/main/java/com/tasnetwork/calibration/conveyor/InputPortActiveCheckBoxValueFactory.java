...
public class InputPortActiveCheckBoxValueFactory
	...
	public ObservableValue<CheckBox> call(CellDataFeatures<InputPort, CheckBox> param) {
		...
		checkBox.selectedProperty().addListener((ov, old_val, new_val) -> {
			...
			// ApplicationLauncher.logger.debug("InputPortActiveCheckBoxValueFactory :
			// new_val : " + new_val);
			// ApplicationLauncher.logger.debug("InputPortActiveCheckBoxValueFactory :
			...
			if (new_val) {
				...
				ApplicationLauncher.logger.debug("InputPortActiveCheckBoxValueFactory : getStateDescription-1 : "
						+ rowData.getStateDescription());
			} else {
				rowData.setStateDescription(rowData.getOffStateDesc());
				ApplicationLauncher.logger.debug("InputPortActiveCheckBoxValueFactory : getStateDescription-2: "
						+ rowData.getStateDescription());
			}
