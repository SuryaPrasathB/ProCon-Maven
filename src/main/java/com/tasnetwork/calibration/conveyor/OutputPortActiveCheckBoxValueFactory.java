...
public class OutputPortActiveCheckBoxValueFactory implements Callback<TableColumn.CellDataFeatures<OutputPort, CheckBox>, ObservableValue<CheckBox>> {
    ...
    public OutputPortActiveCheckBoxValueFactory(OutputPortTableViewRefresher controller) {
	    ...
	    public ObservableValue<CheckBox> call(CellDataFeatures<OutputPort, CheckBox> param) {
	        ...
	        checkBox.selectedProperty().addListener((ov, old_val, new_val) -> {
	        	...
	        	//ApplicationLauncher.logger.debug("OutputPortActiveCheckBoxValueFactory : new_val : " + new_val);
	        	//ApplicationLauncher.logger.debug("OutputPortActiveCheckBoxValueFactory : getOnStateDesc : " + rowData.getOnStateDesc());
	        	//ApplicationLauncher.logger.debug("OutputPortActiveCheckBoxValueFactory : getOffStateDesc : " + rowData.getOffStateDesc());
	        	if(new_val) {
