...
public class MainControlPaneController implements Initializable {
    ...
    private BayStateEngine activeLoadingEngine;
    private BayStateEngine activeUnloadingEngine;
    ...
    public void btnRjStartOnClick() {
        ...
        Thread waitForStartCompletion = new Thread(() -> {
            try {
                ...
                Platform.runLater(() -> {
                    DashboardController.highlightRedBay(DashboardController.getRef_rejectionBayContainer()); // Not
                                                                                                             // applicable
                                                                                                             // for this
                                                                                                             // bay
    ...
    public void btnRjStopOnClick() {
        ...
        Thread waitForStopCompletion = new Thread(() -> {
            try {
                ...
                Platform.runLater(() -> {
                    DashboardController.resetBayHighlight(DashboardController.getRef_rejectionBayContainer()); // Not
                                                                                                               // applicable
                                                                                                               // for
                                                                                                               // this
                                                                                                               // bay
            ...
            try {
                ...
                Platform.runLater(() -> {
                    ...
                    ConveyorDataManager.getDashboardObject().getBayIndicatorManager()
                            .stopTimeUpDisplay(ConstantConveyor.FT_BAY_KEY);
                    ConveyorDataManager.getDashboardObject().getBayIndicatorManager()
                            .stopProgressBarWithTime(ConstantConveyor.FT_BAY_KEY);
        ...
        Thread waitForStopCompletion = new Thread(() -> {
            try {
                ...
                Platform.runLater(() -> {
                    ...
                    ConveyorDataManager.getDashboardObject().getBayIndicatorManager()
                            .stopTimeUpDisplay(ConstantConveyor.HV_BAY_KEY);
                    ConveyorDataManager.getDashboardObject().getBayIndicatorManager()
                            .stopProgressBarWithTime(ConstantConveyor.HV_BAY_KEY);
        ...
        Thread waitForStopCompletion = new Thread(() -> {
            try {
                ...
                Platform.runLater(() -> {
                    ...
                    ConveyorDataManager.getDashboardObject().getBayIndicatorManager()
                            .stopTimeUpDisplay(ConstantConveyor.IR_BAY_KEY);
                    ConveyorDataManager.getDashboardObject().getBayIndicatorManager()
                            .stopProgressBarWithTime(ConstantConveyor.IR_BAY_KEY);
        ...
        Thread waitForStopCompletion = new Thread(() -> {
            try {
                ...
                Platform.runLater(() -> {
                    ...
                    ConveyorDataManager.getDashboardObject().getBayIndicatorManager()
                            .stopTimeUpDisplay(ConstantConveyor.CALIBRATION_BAY_KEY);
                    ConveyorDataManager.getDashboardObject().getBayIndicatorManager()
                            .stopProgressBarWithTime(ConstantConveyor.CALIBRATION_BAY_KEY);
        ...
        Thread waitForStopCompletion = new Thread(() -> {
            try {
                ...
                Platform.runLater(() -> {
                    ...
                    ConveyorDataManager.getDashboardObject().getBayIndicatorManager()
                            .stopTimeUpDisplay(ConstantConveyor.STA_NLD1_PP1_BAY_KEY);
                    ConveyorDataManager.getDashboardObject().getBayIndicatorManager()
                            .stopProgressBarWithTime(ConstantConveyor.STA_NLD1_PP1_BAY_KEY);
        ...
        Thread waitForStopCompletion = new Thread(() -> {
            try {
                ApplicationLauncher.logger
                        .info("SCT NLT BAY 2 : awaiting for isStopProcessCompletedSctNltBay2 : Entry");
                while (!StaNld_Bay2.isStopProcessCompletedStaNldBay2()) {
                    Thread.sleep(200);
                    ApplicationLauncher.logger
                            .info("SCT NLT BAY 2 : still awaiting for isStopProcessCompletedSctNltBay2");
                }
                ...
                Platform.runLater(() -> {
                    ...
                    ConveyorDataManager.getDashboardObject().getBayIndicatorManager()
                            .stopTimeUpDisplay(ConstantConveyor.STA_NLD2_PP1_BAY_KEY);
                    ConveyorDataManager.getDashboardObject().getBayIndicatorManager()
                            .stopProgressBarWithTime(ConstantConveyor.STA_NLD2_PP1_BAY_KEY);
    ...
    public void btnCommTestStartOnClick() {
        ...
        Thread waitForStartCompletion = new Thread(() -> {
            try {
                ...
                // Once start is completed, update UI
                Platform.runLater(() -> {
                    // DashboardController.highlightBay(DashboardController.getRef_bayXContainer());
                    // // Not applicable for this bay
    ...
    public void btnUnloadingStartOnClick() {
        ...
        Thread waitForStartCompletion = new Thread(() -> {
            try {
                ...
                // Once start is completed, update UI
                Platform.runLater(() -> {
                    DashboardController.highlightGreenBay(DashboardController.getRef_unloadingBayContainer()); // Not
                                                                                                               // applicable
                                                                                                               // for
                                                                                                               // this
                                                                                                               // bay
