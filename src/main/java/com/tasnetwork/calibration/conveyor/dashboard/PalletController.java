...
/*	private Timeline blinkTimelinePalletsExistInQueue;
	...
	@FXML private ProgressBar pBarPalletExecution;
	...
	@FXML private TextField serial1;
	@FXML private TextField serial2;
	@FXML private TextField serial3;
	@FXML private TextField serial4;
	@FXML private TextField serial5;
	@FXML private TextField serial6;

	@FXML private Rectangle meter1;
	@FXML private Rectangle meter2;
	@FXML private Rectangle meter3;
	@FXML private Rectangle meter4;
	@FXML private Rectangle meter5;
	@FXML private Rectangle meter6;

	@FXML private Text errorCode1;
	@FXML private Text errorCode2;
	@FXML private Text errorCode3;
	@FXML private Text errorCode4;
	@FXML private Text errorCode5;
	@FXML private Text errorCode6;
...
/*		palletRoot.setOnContextMenuRequested(event -> {
		...
		// tooltip1.setShowDelay(javafx.util.Duration.millis(500)); // You can adjust this value
	}
...
/*	private void createContextMenu() {
		...
		if (bayTypeKey.equals(ConstantConveyor.FT_BAY_KEY)) {
			...
			ApplicationLauncher.logger.warn("createContextMenu: Unknown bayType " + bayTypeKey);
		}
	}*/
...
/*	private void disengageCalibrationFingertip() {
	...
	public void setErrorCodeByPosition(int position, String errorCode) {
		switch (position) {
		case 1: errorCode1.setText(errorCode); break;
		case 2: errorCode2.setText(errorCode); break;
		case 3: errorCode3.setText(errorCode); break;
		case 4: errorCode4.setText(errorCode); break;
		case 5: errorCode5.setText(errorCode); break;
		case 6: errorCode6.setText(errorCode); break;
		}
	}
