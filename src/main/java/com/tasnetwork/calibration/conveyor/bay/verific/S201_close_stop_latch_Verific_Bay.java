...
public class S201_close_stop_latch_Verific_Bay implements VerificTestBayState {
    ...
    private Map<String, Object> close_StopLatch_Verific_Bay() {
        ...
        if (portInfo != null) {
            ...
            Verification.logger
                    .debug("S201_close_stop_latch_Verific_Bay : close_StopLatch_Verific_Bay : state : " + state);
            /*
            ...
            Verification.logger
                    .debug("S201_close_stop_latch_Verific_Bay : close_StopLatch_Verific_Bay : status : " + status);
        ...
        Verification.logger
                .debug("S201_close_stop_latch_Verific_Bay : verificBay_StopLatch_Status : status : " + status);
