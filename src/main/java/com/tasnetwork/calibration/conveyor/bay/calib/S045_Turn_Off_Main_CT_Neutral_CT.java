...
public class S045_Turn_Off_Main_CT_Neutral_CT implements CalibrationBayState {
	...
	public static void setCtResetRequest(boolean ctResetRequest) {
		S045_Turn_Off_Main_CT_Neutral_CT.ctResetRequest = ctResetRequest;
	}

	public static void setCtResetRequestAcknowledged(boolean ctResetRequestAcknowledged) {
		S045_Turn_Off_Main_CT_Neutral_CT.ctResetRequestAcknowledged = ctResetRequestAcknowledged;
	}
