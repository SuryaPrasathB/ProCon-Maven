...
public class S04_ensure_the_fingerTip_Latch_Closed implements VerificTestBayState {
    ...
    private Map<String, Object> verificBay_FingerTipLatch_Status() {
        ...
        IoPortInfo portInfo = BayUtils
                .getInputPortDetails(ConstantBayPortNameMapping.VERIFIC_PORT_NAME_SNSR_FINGER_TIP);
        ...
        if (portInfo != null) {
            testInterfaceStatus = new TestInterfaceStatus(
                    ...
                    "-",
                    portInfo.getPortId(),
                    ConstantBayPortNameMapping.VERIFIC_PORT_NAME_SNSR_FINGER_TIP,
            ...
            Verification.logger.debug(
                    "S04_ensure_the_fingerTip_Latch_Closed : verificBay_FingerTipLatch_Status : Output port not found");
        ...
        Verification.logger
                .debug("S04_ensure_the_fingerTip_Latch_Closed : verificBay_FingerTipLatch_Status : state : " + state);
