...
public class S211_open_stop_latch2_Verific_Bay implements VerificTestBayState {
    ...
    public BayResponse handleRequest() {
        ...
        if (openStopLatch_Verific_Bay) {
            Verification.logger.info("S211_open_stop_latch2_Verific_Bay : Stop Latch Opened");
            bayResponse.setStatus(true);
            bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_601);
            BayUtils.delay(3000);
        } else {
    ...
    private Map<String, Object> open_StopLatch_Verific_Bay() {
        Verification.logger.debug("S211_open_stop_latch2_Verific_Bay : verificBay_StopLatch_Status : Entry");
