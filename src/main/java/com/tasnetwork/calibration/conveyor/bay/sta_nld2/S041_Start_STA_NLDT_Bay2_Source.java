...
public class S041_Start_STA_NLDT_Bay2_Source implements STA_NoLoadTestBay2State {
	 ...
	 * debug("S071_start_STA_NLDT_source : startSTA_NLDTSource : Entry");
	 * 
	 ...
	 * STA_NoLoadTestBay2.logger.
	 * debug("S071_start_STA_NLDT_source : startSTA_NLDTSource : Turned on Source Start Pin : Success"
	 * );
	 * BayUtils.delay(500);
	 * } else {
	 * STA_NoLoadTestBay2.logger.
	 * debug("S071_start_STA_NLDT_source : startSTA_NLDTSource : Failed to turn on Source Start Pin"
	 * );
	 ...
	 * if (status) {
	 * STA_NoLoadTestBay2.logger.
	 * debug("S08_functional_Test : startSTA_NLDTSource : Turned Off Source Start Pin : Success"
	 * );
	 * 
	 * } else {
	 * STA_NoLoadTestBay2.logger.
	 * debug("S08_functional_Test : startSTA_NLDTSource : Failed to turn off Source Start Pin"
	 * );
	 * status = false;
	 * }
	 * 
	 ...
	 * 
	 * STA_NoLoadTestBay2.logger.
	 * debug("S08_functional_Test : startSTA_NLDTSource : Exit");
