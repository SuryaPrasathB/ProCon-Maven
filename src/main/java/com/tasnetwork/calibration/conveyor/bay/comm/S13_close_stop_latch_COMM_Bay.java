...
public class S13_close_stop_latch_COMM_Bay implements CommTestBayState {

    @Override
    public BayResponse handleRequest() {
        Comm.logger.info("S13_close_stop_latch_COMM_Bay : Entry");
        ...
        Comm.logger.info("S13_close_stop_latch_COMM_Bay : Exit");
        return bayResponse;
    }

    private Map<String, Object> close_StopLatch_COMM_Bay() {
        Comm.logger.debug("S13_close_stop_latch_COMM_Bay : commBay_StopLatch_Status : Entry");
        ...
        Comm.logger.debug("S13_close_stop_latch_COMM_Bay : commBay_StopLatch_Status : status : " + status);
        Comm.logger.debug("S13_close_stop_latch_COMM_Bay : commBay_StopLatch_Status : Exit");
        return responseReturn;
    }
}
