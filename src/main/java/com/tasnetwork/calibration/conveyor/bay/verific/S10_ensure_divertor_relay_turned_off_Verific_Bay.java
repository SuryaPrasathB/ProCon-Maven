...
public class S10_ensure_divertor_relay_turned_off_Verific_Bay implements VerificTestBayState {
    ...
    private Map<String, Object> divertorRelay_Status() {
        ...
        state = state.equals(Constant_IO_ActionMapping.OFF) ? Constant_IO_ActionMapping.OFF
        ...
        Verification.logger
                .debug("S10_ensure_divertor_relay_turned_off_Verific_Bay : divertorRelay_Status : state : " + state);
