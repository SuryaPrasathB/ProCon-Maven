...
public class S051_Stop_VerificTest_Source implements VerificTestBayState {
	 ...
	 * debug("S071_stop_Verific_source : stopCalibSource : Entry");
	 * 
	 ...
	 * VerificationTestBay.logger.
	 * debug("S071_stop_Verific_source : stopCalibSource : Turned on Source stop Pin : Success"
	 * );
	 * BayUtils.delay(500);
	 * } else {
	 * VerificationTestBay.logger.
	 * debug("S071_stop_Verific_source : stopCalibSource : Failed to turn on Source stop Pin"
	 * );
	 ...
	 * if (status) {
	 * VerificationTestBay.logger.
	 * debug("S08_functional_Test : stopCalibSource : Turned Off Source stop Pin : Success"
	 * );
	 * 
	 * } else {
	 * VerificationTestBay.logger.
	 * debug("S08_functional_Test : stopCalibSource : Failed to turn off Source stop Pin"
	 * );
	 * status = false;
	 * }
	 * 
	 ...
	 * 
	 * VerificationTestBay.logger.
	 * debug("S08_functional_Test : stopCalibSource : Exit");
	...
	private Map<String, Object> stopCalibSource() {
		...
		Verification.logger
				.debug("S071_turn_on_stop_pin_ft_bay : stopCalibSource : status : " + responseReturn.get("status"));
