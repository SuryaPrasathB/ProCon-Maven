...
//===========================================================================================
    ...
    private Map<String,Object> open_StopLatch_VerificBay() {
        ...
        Verification.logger.debug("S11_let_the_pallets_to_SCT_NLT_Bay1 : open_StopLatch_VerificBay : status : " + status);
        //============================================================================================   
    ...
    private Map<String, Object> close_StopLatch_VerificBay() {
        ...
        Verification.logger.debug("S11_let_the_pallets_to_SCT_NLT_Bay1 : close_StopLatch_VerificBay : status : " + status);
        //============================================================================================   
