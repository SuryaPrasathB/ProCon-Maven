    ...
    private Map<String, Object> sctNltBay2_FingerTipLatch_Status() {
        ...
        if (portInfo != null) {
            ...
            StaNld_Bay2.logger.debug(
                    "S04_ensure_the_fingerTip_Latch_Closed : sctNltBay2_FingerTipLatch_Status : Output port not found");
        ...
        StaNld_Bay2.logger
                .debug("S04_ensure_the_fingerTip_Latch_Closed : sctNltBay2_FingerTipLatch_Status : state : " + state);
