...
public class S30_turn_off_tower_lamp_Verific_Bay implements VerificTestBayState {

    // ===========================================================================================
    @Override
    public BayResponse handleRequest() {
        Verification.logger.info("S30_turn_off_tower_lamp_Verific_Bay : Entry");
        ...
        if (turn_on_red_lamp) {
            Verification.logger.info("S30_turn_off_tower_lamp_Verific_Bay : turn_on_tower_lamp : Success");
            ...
            if (turn_off_green_lamp) {
                Verification.logger.info("S30_turn_off_tower_lamp_Verific_Bay : turn_off_tower_lamp : Success");
                bayResponse.setStatus(true);
                bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_601);
            } else {
                Verification.logger.info("S30_turn_off_tower_lamp_Verific_Bay : Failed to turn_off_tower_lamp RED");
                bayResponse.setStatus(false);
                bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_HVT_014);
            }
        } else {
            Verification.logger.info("S30_turn_off_tower_lamp_Verific_Bay : Failed to turn_on_tower_lamp GREEN");
            bayResponse.setStatus(false);
            bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_HVT_014);
        }
        ...
        Verification.logger.info("S30_turn_off_tower_lamp_Verific_Bay : Exit");
        return bayResponse;
    }
    ...
    private Map<String, Object> turn_off_tower_lamp() {
        Verification.logger.debug("S30_turn_off_tower_lamp_Verific_Bay : turn_off_tower_lamp : Entry");
        ...
        if (portInfo != null) {
            ...
            Verification.logger.debug("S30_turn_off_tower_lamp_Verific_Bay : Output port not found");
        ...
        Verification.logger.debug("S30_turn_off_tower_lamp_Verific_Bay : Exit");
        return responseReturn;
    }
    ...
    private Map<String, Object> turn_on_tower_lamp() {
        Verification.logger.debug("S30_turn_off_tower_lamp_Verific_Bay : turn_on_tower_lamp : Entry");
        ...
        Verification.logger.debug("S30_turn_off_tower_lamp_Verific_Bay : turn_on_tower_lamp : status : " + status);
        // ============================================================================================
