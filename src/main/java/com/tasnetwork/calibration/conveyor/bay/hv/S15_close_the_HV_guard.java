...
public class S15_close_the_HV_guard implements HvtBayState {
    ...
    public BayResponse handleRequest() {
        ...
        if (close_hv_guard_HvtBay) {
            Hv.logger.info("S15_close_the_HV_guard : close_hv_guard_HvtBay : Finger Tip Latch Closed");
            bayResponse.setStatus(true);
            bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_601);
        } else {
            Hv.logger.info("S15_close_the_HV_guard : close_hv_guard_HvtBay : Failed to Close Finger Tip Latch");
            bayResponse.setStatus(false);
            bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_HVT_003);
        }

        Hv.logger.info("S15_close_the_HV_guard : Exit");
        return bayResponse;
    }
    //============================================================================================================================================  

    private Map<String,Object> close_hv_guard_HvtBay() {
        Hv.logger.debug("S15_close_the_HV_guard : close_hv_guard_HvtBay : Entry");
        ...
        //============================================================================================  
        Hv.logger.debug("S15_close_the_HV_guard : close_hv_guard_HvtBay : status : " + status); 
		Hv.logger.debug("S15_close_the_HV_guard : close_hv_guard_HvtBay : Exit");
