...
public class FunctionalTestBayReset extends TimerTask{
	...
	public BayResponse processCurrentState(){
		...
		Ft.logger.debug("processCurrentState : " + ftBayResetStateManager.getState().getClass().getSimpleName() + " : Status     : " + bayStatus.isStatus());
		Ft.logger.debug("processCurrentState : " + ftBayResetStateManager.getState().getClass().getSimpleName() + " : Error Code : " + bayStatus.getErrorCode());
		return bayStatus ;
	}
	//====================================================================================================================
	...
	public void manageFunctionalTestBayResetStates2() {
		...
		ArrayList<StateFlow> statePlanner = (ArrayList<StateFlow>) MySqlServiceManager.getStateFlowService().findByBayKeyAndExecutionMode(ConstantConveyor.FT_BAY_KEY, "RESET");
		...
		if(getTableStatePlanner_FtBay().size()>0) {
			...
			Ft.logger.debug("FunctionalTestBay : manageFunctionalTestBayResetStates2 : getTableStatePlanner2 : Size : " + getTableStatePlanner_FtBay().size());
