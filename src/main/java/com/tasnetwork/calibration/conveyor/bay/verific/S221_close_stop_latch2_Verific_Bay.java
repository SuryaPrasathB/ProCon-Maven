...
public class S221_close_stop_latch2_Verific_Bay implements VerificTestBayState {
    ...
    public BayResponse handleRequest() {
        ...
        Verification.logger.info("S221_close_stop_latch2_Verific_Bay : getPalletsPassedVerificBay()" + S191_open_stop_latch_Verific_Bay.getPalletsPassedVerificBay());
        ...
        if (S191_open_stop_latch_Verific_Bay.getPalletsPassedVerificBay() == ConstantConveyor.NUM_PALLETS_VERFIC_BAY) {
            ...
            Verification.logger.info("S221_close_stop_latch2_Verific_Bay : palletMoveMentverificToSta2 : palletMoveMentWaiting stop:");
    ...
    private Map<String, Object> close_StopLatch_Verific_Bay() {
        ...
        if (portInfo != null) {
            ...
            Verification.logger.debug("S221_close_stop_latch2_Verific_Bay : close_StopLatch_Verific_Bay : state : " + state);
            ...
            Verification.logger.debug("S221_close_stop_latch2_Verific_Bay : close_StopLatch_Verific_Bay : status : " + status);
        ...
        Verification.logger.debug("S221_close_stop_latch2_Verific_Bay : verificBay_StopLatch_Status : status : " + status);
