...
public class S29_turn_on_tower_lamp_HVT_Bay implements HvtBayState {
    ...
    public BayResponse handleRequest() {
		...
		if (turn_on_red_lamp) {   	
            ...
            if (turn_off_green_lamp) {
            	Hv.logger.info("S29_turn_on_tower_lamp_HVT_Bay : turn_off_tower_lamp : Success");
                bayResponse.setStatus(true);
                bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_601);
			} 
            else {
            	Hv.logger.info("S29_turn_on_tower_lamp_HVT_Bay : Failed to turn_off_tower_lamp GREEN");
                 bayResponse.setStatus(false);
                 bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_HVT_014 );
			}    
        } else {
        	Hv.logger.info("S29_turn_on_tower_lamp_HVT_Bay : Failed to turn_on_tower_lamp RED");
            bayResponse.setStatus(false);
            bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_HVT_014 );
        }

        Hv.logger.info("S29_turn_on_tower_lamp_HVT_Bay : Exit");
        return bayResponse;
    }
  ...
  //============================================================================================================================================  
    ...
    private Map<String,Object> turn_on_tower_lamp() {
        Hv.logger.debug("S29_turn_on_tower_lamp_HVT_Bay : turn_on_tower_lamp : Entry");
        ...
        if (portInfo != null) {
            ...
            Hv.logger.debug("S29_turn_on_tower_lamp_HVT_Bay : Output port not found");
        ...
        Hv.logger.debug("S29_turn_on_tower_lamp_HVT_Bay : turn_on_tower_lamp : status : " + status);
        //============================================================================================  
        ...
        Hv.logger.debug("S29_turn_on_tower_lamp_HVT_Bay : Exit");
        return responseReturn;
    }
    
    private Map<String,Object> turn_off_tower_lamp() {
        Hv.logger.debug("S29_turn_on_tower_lamp_HVT_Bay : turn_off_tower_lamp : Entry");
        ...
        Hv.logger.debug("S29_turn_on_tower_lamp_HVT_Bay : turn_off_tower_lamp : status : " + status);
        //============================================================================================  
