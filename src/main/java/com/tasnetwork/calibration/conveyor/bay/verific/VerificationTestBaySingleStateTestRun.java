...
public class VerificationTestBaySingleStateTestRun extends TimerTask {
	...
	private void singleStateTestRun() {
		...
		VerificTestBayState currentState = VerificTestBayState.createState(stateName);

		setNextState(currentState);

		BayResponse bayStatus = processCurrentState();

		Verification.logger.debug("VerificationTestBaySingleStateTestRun : singleStateTestRun : bayStatus : Status : "
				+ bayStatus.getStatus());
		Verification.logger
				.debug("VerificationTestBaySingleStateTestRun : singleStateTestRun : bayStatus : Error Code : "
	...
	public BayResponse processCurrentState() {
		...
		Verification.logger
				.debug("processCurrentState : " + verificBayStateManager.getState().getClass().getSimpleName()
