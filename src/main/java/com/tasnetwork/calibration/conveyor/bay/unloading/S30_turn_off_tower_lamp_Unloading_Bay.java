...
public class S30_turn_off_tower_lamp_Unloading_Bay implements UnloadingBayState {
    ...
    public BayResponse handleRequest() {
        Unloading.logger.info("S30_turn_off_tower_lamp_Unloading_Bay : Entry");
        ...
        if (turn_off_divertor_relay_FT_Bay) {
            Unloading.logger.info("S30_turn_off_tower_lamp_Unloading_Bay : Tower Lamp Turned Off");
            bayResponse.setStatus(true);
            bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_601);
        } else {
            Unloading.logger.info("S30_turn_off_tower_lamp_Unloading_Bay : Failed to Turn Off Tower Lamp");
            bayResponse.setStatus(false);
            bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_FT_017);
        }

        Unloading.logger.info("S30_turn_off_tower_lamp_Unloading_Bay : Exit");
        return bayResponse;
    }
    ...
    private Map<String,Object> turn_off_tower_lamp() {
        Unloading.logger.debug("S30_turn_off_tower_lamp_Unloading_Bay : turn_off_tower_lamp : Entry");
        ...
        if (portInfo != null) {
            ...
            Unloading.logger.debug("S30_turn_off_tower_lamp_Unloading_Bay : Output port not found");
        ...
        Unloading.logger.debug("S30_turn_off_tower_lamp_Unloading_Bay : turn_off_tower_lamp : status : " + status);
        //============================================================================================  
        ...
        Unloading.logger.debug("S30_turn_off_tower_lamp_Unloading_Bay : Exit");
        return responseReturn;
    }
}
