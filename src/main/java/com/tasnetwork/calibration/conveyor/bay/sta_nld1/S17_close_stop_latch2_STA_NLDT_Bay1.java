...
public class S17_close_stop_latch2_STA_NLDT_Bay1 implements STA_NoLoadTestBay1State {
    ...
    public BayResponse handleRequest() {
        ...
        StaNld_Bay1.logger
                .info("S17_close_stop_latch2_STA_NLDT_Bay1 : getPalletsPassedSTA_NLDT_Bay1()" + passedPallets);

        if (S16_open_stop_latch_STA_NLDT_Bay1
                .getPalletsPassedSTA_NLDT_Bay1() == ConstantConveyor.NUM_PALLETS_STA_NLD1_BAY1) {
            ...
            StaNld_Bay1.logger.info("S17_close_stop_latch2_STA_NLDT_Bay1 : last pallet exit wait time: "
                    + DeviceDataManagerController.getConveyorConfigParsedKey().getSta1LastPalletExitWaitTime_InSec()
                    + " Sec");
            BayUtils.delay(
                    DeviceDataManagerController.getConveyorConfigParsedKey().getSta1LastPalletExitWaitTime_InSec()
                            * 1000);
    ...
    private Map<String, Object> close_StopLatch_SCT_NLT_Bay1() {
        ...
        if (portInfo != null) {
            ...
            StaNld_Bay1.logger
                    .debug("S17_close_stop_latch2_STA_NLDT_Bay1 : close_StopLatch_SCT_NLT_Bay1 : state : " + state);
            ...
            StaNld_Bay1.logger
                    .debug("S17_close_stop_latch2_STA_NLDT_Bay1 : close_StopLatch_SCT_NLT_Bay1 : status : " + status);
        ...
        StaNld_Bay1.logger
                .debug("S17_close_stop_latch2_STA_NLDT_Bay1 : sctNltBay1_StopLatch_Status : status : " + status);
