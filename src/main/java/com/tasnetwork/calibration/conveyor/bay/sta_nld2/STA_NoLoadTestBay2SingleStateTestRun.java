...
public class STA_NoLoadTestBay2SingleStateTestRun extends TimerTask {
	...
	private void singleStateTestRun() {
		...
		StaNld_Bay2.logger
				.debug("ShortCircuit_NoLoadTestBay2SingleStateTestRun : singleStateTestRun : bayStatus : Status : "
						+ bayStatus.getStatus());
		StaNld_Bay2.logger
				.debug("ShortCircuit_NoLoadTestBay2SingleStateTestRun : singleStateTestRun : bayStatus : Error Code : "
	...
	public BayResponse processCurrentState() {
		...
		StaNld_Bay2.logger.debug("processCurrentState : " + sctNltBay2StateManager.getState().getClass().getSimpleName()
