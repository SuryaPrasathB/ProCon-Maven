...
public class S046_Stop_Execution_Bay2 implements STA_NoLoadTestBay2State  {
	...
	public BayResponse handleRequest() {
		StaNld_Bay2.logger.info("S046_Stop_Execution : Entry");
		...
		if (procalServerResponse.equals("testStopInitiated")) {
			BayUtils.delay(1000);
			StaNld_Bay2.logger.info("S046_Stop_Execution : Stop Execution Success");
			bayResponse.setStatus(true);
			bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_601);
			
			BayUtils.delay(10000);
		} else {
			StaNld_Bay2.logger.info("S046_Stop_Execution : Stop Execution Failed");
		...
		StaNld_Bay2.logger.info("S046_Stop_Execution : Exit");
		return bayResponse;
	}
	...
	public static void setStopExecutionRequested(boolean stopExecutionRequested) {
		S046_Stop_Execution_Bay2.stopExecutionRequested = stopExecutionRequested;
	}
