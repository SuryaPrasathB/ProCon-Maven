...
public class S29_turn_on_tower_lamp_STA_NLDT_Bay2 implements STA_NoLoadTestBay2State {

    //===========================================================================================
    @Override
    public BayResponse handleRequest() {
        StaNld_Bay2.logger.info("S29_turn_on_tower_lamp_STA_NLDT_Bay2 : Entry");
        ...
        if (turn_on_red_lamp) {   	
        	StaNld_Bay2.logger.info("S29_turn_on_tower_lamp_STA_NLDT_Bay2 : turn_on_tower_lamp : Success");
            ...
            if (turn_off_green_lamp) {
            	StaNld_Bay2.logger.info("S29_turn_on_tower_lamp_STA_NLDT_Bay2 : turn_off_tower_lamp : Success");
                bayResponse.setStatus(true);
                bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_601);
			} 
            else {
            	StaNld_Bay2.logger.info("S29_turn_on_tower_lamp_STA_NLDT_Bay2 : Failed to turn_off_tower_lamp GREEN");
                 bayResponse.setStatus(false);
                 bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_HVT_014 );
			}    
        } else {
        	StaNld_Bay2.logger.info("S29_turn_on_tower_lamp_STA_NLDT_Bay2 : Failed to turn_on_tower_lamp RED");
            bayResponse.setStatus(false);
            bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_HVT_014 );
        }

        StaNld_Bay2.logger.info("S29_turn_on_tower_lamp_STA_NLDT_Bay2 : Exit");
        return bayResponse;
    }
  ...
  //============================================================================================================================================  
    ...
    private Map<String,Object> turn_on_tower_lamp() {
        StaNld_Bay2.logger.debug("S29_turn_on_tower_lamp_STA_NLDT_Bay2 : turn_on_tower_lamp : Entry");
        ...
        if (portInfo != null) {
            ...
            StaNld_Bay2.logger.debug("S29_turn_on_tower_lamp_STA_NLDT_Bay2 : Output port not found");
        ...
        StaNld_Bay2.logger.debug("S29_turn_on_tower_lamp_STA_NLDT_Bay2 : turn_on_tower_lamp : status : " + status);
        //============================================================================================  
        ...
        StaNld_Bay2.logger.debug("S29_turn_on_tower_lamp_STA_NLDT_Bay2 : Exit");
        return responseReturn;
    }
    
    private Map<String,Object> turn_off_tower_lamp() {
        StaNld_Bay2.logger.debug("S29_turn_on_tower_lamp_STA_NLDT_Bay2 : turn_off_tower_lamp : Entry");
        ...
        StaNld_Bay2.logger.debug("S29_turn_on_tower_lamp_STA_NLDT_Bay2 : turn_off_tower_lamp : status : " + status);
        //============================================================================================  
