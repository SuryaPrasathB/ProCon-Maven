...
public class S04_ensure_the_fingerTip_Latch_Closed_Bay1 implements STA_NoLoadTestBay1State {
    ...
    private Map<String, Object> sctNltBay1_FingerTipLatch_Status() {
        ...
        if (portInfo != null) {
            ...
            StaNld_Bay1.logger.debug("S04_ensure_the_fingerTip_Latch_Closed : sctNltBay1_FingerTipLatch_Status : Output port not found");
        ...
        StaNld_Bay1.logger.debug("S04_ensure_the_fingerTip_Latch_Closed : sctNltBay1_FingerTipLatch_Status : state : " + state);
