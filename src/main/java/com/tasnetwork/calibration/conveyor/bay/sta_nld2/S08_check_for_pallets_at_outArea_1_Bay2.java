...
public class S08_check_for_pallets_at_outArea_1_Bay2 implements STA_NoLoadTestBay2State {
    ...
    public BayResponse handleRequest() {
        ...
        StaNld_Bay2.logger
                .debug("S08_check_for_pallets_at_outArea_1 : isPalletAvailableAt_outArea1 :  BayResponse status : "
                        + bayResponse.getStatus());
    ...
    private Map<String, Object> isPalletAvailableAt_outArea1() {
        ...
        if (portInfo != null) {
            ...
            StaNld_Bay2.logger.debug(
                    "S08_check_for_pallets_at_outArea_1 : isPalletAvailableAt_outArea1 :  Output port not found");
