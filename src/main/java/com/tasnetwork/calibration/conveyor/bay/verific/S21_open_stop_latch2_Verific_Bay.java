...
public class S21_open_stop_latch2_Verific_Bay implements VerificTestBayState {
    ...
    private Map<String, Object> open_StopLatch_Verific_Bay() {
        ...
        if (portInfo != null) {
            ...
            Verification.logger
                    .debug("S21_open_stop_latch2_Verific_Bay : open_StopLatch_Verific_Bay : state : " + state);
            /*
            ...
            Verification.logger
                    .debug("S21_open_stop_latch2_Verific_Bay : open_StopLatch_Verific_Bay : status : " + status);
        ...
        Verification.logger
                .debug("S21_open_stop_latch2_Verific_Bay : verificBay_StopLatch_Status : status : " + status);
