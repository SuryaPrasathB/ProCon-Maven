...
public class S091_check_for_no_pallets_at_unloading_Bay1 implements STA_NoLoadTestBay1State {
    ...
    public BayResponse handleRequest() {
        StaNld_Bay1.logger.info("S091_check_for_no_pallets_at_unloading_Bay : Entry");
        ...
        while (!stableDetectionForNoPallet 
            ...
            if (!isPalletAvailableAt_UnloadingBay) {
                ...
                StaNld_Bay1.logger.info("S091_check_for_no_pallets_at_unloading_Bay : No pallet Available at UnloadingBay");
                BayUtils.delay(1000);
            }
        }

        if (stableDetectionForNoPallet) {
            StaNld_Bay1.logger.info("S091_check_for_no_pallets_at_unloading_Bay : Pallet Not Available");
            bayResponse.setStatus(true);
            bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_601);
        } else {
            StaNld_Bay1.logger.info("S091_check_for_no_pallets_at_unloading_Bay : Pallet Available");
        ...
        StaNld_Bay1.logger.info("S091_check_for_no_pallets_at_unloading_Bay : Exit");
        return bayResponse;
    }
//==========================================================================================================
    private Map<String,Object> isPalletAvailableAt_UnloadingBay() {
        StaNld_Bay1.logger.debug("S091_check_for_no_pallets_at_unloading_Bay : isPalletAvailableAt_UnloadingBay : Entry");
        ...
        if (portInfo != null) {
            ...
            StaNld_Bay1.logger.debug("S091_check_for_no_pallets_at_unloading_Bay : isPalletAvailableAt_UnloadingBay : Output port not found");
        ...
        StaNld_Bay1.logger.debug("S091_check_for_no_pallets_at_unloading_Bay : isPalletAvailableAt_UnloadingBay : state : " + state);
        ...
        StaNld_Bay1.logger.debug("S091_check_for_no_pallets_at_unloading_Bay : isPalletAvailableAt_UnloadingBay : status : " + status); 

		responseReturn.put("status", status);
		

        StaNld_Bay1.logger.debug("S091_check_for_no_pallets_at_unloading_Bay : isPalletAvailableAt_UnloadingBay : Exit");
        return responseReturn;
    }
