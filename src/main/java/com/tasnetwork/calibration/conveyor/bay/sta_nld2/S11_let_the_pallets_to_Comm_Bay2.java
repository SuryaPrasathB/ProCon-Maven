...
public class S11_let_the_pallets_to_Comm_Bay2 implements STA_NoLoadTestBay2State {
    ...
    private Map<String, Object> open_StopLatch_SctNltBay2() {
        ...
        if (portInfo != null) {
            ...
            StaNld_Bay2.logger.debug(
                    "S11_let_the_pallets_to_Comm_Bay : open_StopLatch_SctNltBay2 : Stopper Output port not found");
    ...
    private Map<String, Object> close_StopLatch_SctNltBay2() {
        ...
        if (portInfo != null) {
            ...
            StaNld_Bay2.logger.debug(
                    "S11_let_the_pallets_to_Comm_Bay : close_StopLatch_SctNltBay2 : Stopper Output port not found");
            return responseReturn;
        }
