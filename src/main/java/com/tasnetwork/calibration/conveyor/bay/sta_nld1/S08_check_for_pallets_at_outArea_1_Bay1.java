...
//==================================================================================================
    private Map<String,Object> isPalletAvailableAt_outArea1() {
        ...
        IoPortInfo portInfo = BayUtils.getInputPortDetails(ConstantBayPortNameMapping.UNLOADING_PORT_NAME_SNSR_PALLET); // Minor Fix Applied, please verify on the placement of the scanner and adjust accordingly - SCT_NLT_BAY1_SNSR_PALLET2
        ...
        if (portInfo != null) {
            ...
            StaNld_Bay1.logger.debug("S08_check_for_pallets_at_outArea_1 : isPalletAvailableAt_outArea1 : Output port not found");
        ...
        StaNld_Bay1.logger.debug("S08_check_for_pallets_at_outArea_1 : isPalletAvailableAt_outArea1 : state : " + state);
        ...
        StaNld_Bay1.logger.debug("S08_check_for_pallets_at_outArea_1 : isPalletAvailableAt_outArea1 : status : " + status); 
