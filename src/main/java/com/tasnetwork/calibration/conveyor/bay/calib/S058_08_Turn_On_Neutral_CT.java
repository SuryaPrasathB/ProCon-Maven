...
public class S058_08_Turn_On_Neutral_CT implements CalibrationBayState {
    ...
    private Map<String,Object> turn_on_neutral_ct_make_pin() {
		Calib.logger.debug("S043_Turn_On_Neutral_CT : turn_on_neutral_ct_make_pin : Entry");
		...
		Calib.logger.debug("S043_Turn_On_Neutral_CT : turn_on_neutral_ct_make_pin : status : " + status); 
		Calib.logger.debug("S043_Turn_On_Neutral_CT : turn_on_neutral_ct_make_pin : Exit");
		return responseReturn;
	}
    ...
    private Map<String,Object> turn_off_neutral_ct_make_pin() {
		Calib.logger.debug("S043_Turn_On_Neutral_CT : turn_off_neutral_ct_make_pin : Entry");
		...
		if (portInfo != null) {
			...
			Calib.logger.debug("S043_Turn_On_Neutral_CT : turn_off_neutral_ct_make_pin : Output port not found");
		...
		Calib.logger.debug("S043_Turn_On_Neutral_CT : turn_off_neutral_ct_make_pin : status : " + status); 
		Calib.logger.debug("S043_Turn_On_Neutral_CT : turn_off_neutral_ct_make_pin : Exit");
		return responseReturn;
	}
