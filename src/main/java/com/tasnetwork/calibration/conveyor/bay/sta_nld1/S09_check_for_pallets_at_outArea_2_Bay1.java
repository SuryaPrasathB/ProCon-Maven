...
public class S09_check_for_pallets_at_outArea_2_Bay1 implements STA_NoLoadTestBay1State {
    ...
    private Map<String, Object> isPalletAvailableAt_outArea2() {
        ...
        if (portInfo != null) {
            ...
            StaNld_Bay1.logger
                    .debug("S09_check_for_pallets_at_outArea_2 : isPalletAvailableAt_outArea2 : Output port not found");
        ...
        StaNld_Bay1.logger
                .debug("S09_check_for_pallets_at_outArea_2 : isPalletAvailableAt_outArea2 : state : " + state);
        ...
        StaNld_Bay1.logger
                .debug("S09_check_for_pallets_at_outArea_2 : isPalletAvailableAt_outArea2 : status : " + status);
