...
public class S09_check_for_pallets_at_outArea_2_Bay1 implements STA_NoLoadTestBay1State {
    ...
    public BayResponse handleRequest() {
        StaNld_Bay1.logger.info("S09_check_for_pallets_at_outArea_2 : Entry");
        ...
        while (isPalletAvailableAt_outArea2 &&
        	...
        	STA_NoLoadTestBay1.logger.info("S09_check_for_pallets_at_outArea_2 : Pallet Available at Out Area 2");
            BayUtils.delay(1000);
        ...
        if (!isPalletAvailableAt_outArea2) {
            STA_NoLoadTestBay1.logger.info("S09_check_for_pallets_at_outArea_2 : No Pallet Available");
            bayResponse.setStatus(true);
            bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_601);
        } else {
            STA_NoLoadTestBay1.logger.info("S09_check_for_pallets_at_outArea_2 : Pallet Available");
            ...
            if (!isPalletAvailableAt_outArea2) {
             ...
             // If detection lasted for stable pallet time, confirm stability
                if (!isPalletAvailableAt_outArea2) {
                    ...
                    StaNld_Bay1.logger.info("S09_check_for_pallets_at_outArea_2 : Pallet Not Available at Out Area 2");
                }
            } else {
                StaNld_Bay1.logger.info("S09_check_for_pallets_at_outArea_2 : No pallet Available at Out Area 2");
                BayUtils.delay(1000);
            }
        }

        if (stableDetectionForNoPallet) {
            StaNld_Bay1.logger.info("S09_check_for_pallets_at_outArea_2 : Pallet Not Available");
            bayResponse.setStatus(true);
            bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_601);
        } else {
            StaNld_Bay1.logger.info("S09_check_for_pallets_at_outArea_2 : Pallet Available");
            bayResponse.setStatus(false);
            bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_SCT_NLT_BAY1_015);
        }
     ...
     /*   
        ...
        StaNld_Bay1.logger.info("S09_check_for_pallets_at_outArea_2 : Exit");
        return bayResponse;
    }
//==========================================================================================================
    private Map<String,Object> isPalletAvailableAt_outArea2() {
        StaNld_Bay1.logger.debug("S09_check_for_pallets_at_outArea_2 : isPalletAvailableAt_outArea2 : Entry");
        ...
        if (portInfo != null) {
            ...
            StaNld_Bay1.logger.debug("S09_check_for_pallets_at_outArea_2 : isPalletAvailableAt_outArea2 : Output port not found");
        ...
        StaNld_Bay1.logger.debug("S09_check_for_pallets_at_outArea_2 : isPalletAvailableAt_outArea2 : state : " + state);
        ...
        StaNld_Bay1.logger.debug("S09_check_for_pallets_at_outArea_2 : isPalletAvailableAt_outArea2 : status : " + status); 

		responseReturn.put("status", status);
		

        StaNld_Bay1.logger.debug("S09_check_for_pallets_at_outArea_2 : isPalletAvailableAt_outArea2 : Exit");
        return responseReturn;
    }
