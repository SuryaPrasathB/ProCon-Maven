...
/*    String LOW   = "OPEN";
    ...
    public BayResponse handleRequest() {
        ...
        if (turn_on_diverter_of_Verific_Bay) {
            ...
            Verification.logger.info("S13_turn_on_Diverter_of_Verific_Bay : Failed to Turn On Diverter");
            bayResponse.setStatus(false);
            bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_VERIFIC_018);
        }

        Verification.logger.info("S13_turn_on_Diverter_of_Verific_Bay : Exit");
        return bayResponse;
    }
