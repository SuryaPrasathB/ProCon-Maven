...
public class S30_turn_off_tower_lamp1_FT_Bay implements FtBayState {
  ...
  //============================================================================================================================================
    ...
    private Map<String,Object> turn_on_tower_lamp_green() {
        ...
        if (portInfo != null) {
            ...
            String outputActive = Constant_IO_ActionMapping.OPEN; // Use CLOSE to represent turning the relay "On"
