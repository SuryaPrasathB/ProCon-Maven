...
public class S08_close_stop_latch_Waiting_Bay implements WaitingBayState {
    ...
    private Map<String, Object> close_StopLatch_Waiting_Bay() {
        ...
        if (portInfo != null) {
            ...
            VerificWaiting.logger
                    .debug("S08_close_stop_latch_Waiting_Bay : close_StopLatch_Waiting_Bay : state : " + state);
            /*
            ...
            VerificWaiting.logger
                    .debug("S08_close_stop_latch_Waiting_Bay : close_StopLatch_Waiting_Bay : status : " + status);
        ...
        VerificWaiting.logger
                .debug("S08_close_stop_latch_Waiting_Bay : waitingBay_StopLatch_Status : status : " + status);
