...
public class CalibrationBayStop extends TimerTask {
	...
	private void manageCalibrationBayStopStates() {
		...
		ArrayList<StateFlow> statePlanner = (ArrayList<StateFlow>) MySqlServiceManager.getStateFlowService()
				.findByBayKeyAndExecutionMode(ConstantConveyor.CALIBRATION_BAY_KEY, "STOP");// findByBayKey(ConstantConveyor.CALIBRATION_BAY_KEY);
		...
		if (getTableStatePlanner_CalibBay().size() > 0) {
			...
			Calib.logger.debug("CalibrationBayStop : manageCalibrationBayStopStates : getTableStatePlanner2 : Size : "
	...
	public BayResponse processCurrentState() {
		...
		Calib.logger.debug("processCurrentState : " + calibBayStopStateManager.getState().getClass().getSimpleName()
