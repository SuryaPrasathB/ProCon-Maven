...
public class S22_close_stop_latch2_Verific_Bay implements VerificTestBayState {
    ...
    public BayResponse handleRequest() {
        ...
        Verification.logger.info("S22_close_stop_latch2_Verific_Bay : getPalletsPassedVerificBay()"
                + S19_open_stop_latch_Verific_Bay.getPalletsPassedVerificBay());
    ...
    private Map<String, Object> close_StopLatch_Verific_Bay() {
        ...
        if (portInfo != null) {
            ...
            Verification.logger
                    .debug("S22_close_stop_latch2_Verific_Bay : close_StopLatch_Verific_Bay : state : " + state);
            /*
            ...
            Verification.logger
                    .debug("S22_close_stop_latch2_Verific_Bay : close_StopLatch_Verific_Bay : status : " + status);
        ...
        Verification.logger
                .debug("S22_close_stop_latch2_Verific_Bay : verificBay_StopLatch_Status : status : " + status);
