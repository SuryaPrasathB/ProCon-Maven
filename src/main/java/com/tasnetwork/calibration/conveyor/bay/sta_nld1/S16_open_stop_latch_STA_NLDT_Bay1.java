...
public class S16_open_stop_latch_STA_NLDT_Bay1 implements STA_NoLoadTestBay1State {
        ...
        if (openStopLatch_SCT_NLT_Bay1) {
            ...
            if (ProconFeatureEnable.MOTOR_CONTROL_ENABLE) {
                ...
                responseReturn = bayUtils.set_motor_required(getMyBayKey(),
                        Constant_Motor_Requirement.STA1_MOTOR_REQUIRED);
    ...
    private Map<String, Object> open_StopLatch_SCT_NLT_Bay1() {
        ...
        if (portInfo != null) {
            ...
            StaNld_Bay1.logger
                    .debug("S16_open_stop_latch_SCT_NLT_Bay1 : open_StopLatch_SCT_NLT_Bay1 : state : " + state);
            ...
            StaNld_Bay1.logger
                    .debug("S16_open_stop_latch_SCT_NLT_Bay1 : open_StopLatch_SCT_NLT_Bay1 : status : " + status);
