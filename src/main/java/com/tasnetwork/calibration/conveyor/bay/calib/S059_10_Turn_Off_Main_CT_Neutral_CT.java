...
public class S059_10_Turn_Off_Main_CT_Neutral_CT implements CalibrationBayState {
	...
	public BayResponse handleRequest() {
		Calib.logger.info("S045_Turn_Off_Main_CT_Neutral_CT : Entry");
		...
		if (turn_on_main_ct_make_pin) {   	
			Calib.logger.info("S045_Turn_Off_Main_CT_Neutral_CT : turn_on_break_pin : Success");
			...
			if (turn_off_main_ct_make_pin) {
				Calib.logger.info("S045_Turn_Off_Main_CT_Neutral_CT : turn_off_break_pin : Success");
				bayResponse.setStatus(true);
				bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_601);
			} 
			else {
				Calib.logger.info("S045_Turn_Off_Main_CT_Neutral_CT : Failed to turn_off_break_pin Calib Bay");
				bayResponse.setStatus(false);
				bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_CALIB_026 );
			}    
		} else {
			Calib.logger.info("S045_Turn_Off_Main_CT_Neutral_CT : Failed to turn_on_main_ct_make_pin Calib Bay");
			bayResponse.setStatus(false);
			bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_CALIB_026 );
		}
		
		Calib.logger.info("S045_Turn_Off_Main_CT_Neutral_CT : Exit");
		return bayResponse;
	}
	//============================================================================================================================================  

	private Map<String,Object> turn_on_break_pin() {
		Calib.logger.debug("S045_Turn_Off_Main_CT_Neutral_CT : turn_on_break_pin : Entry");
		...
		Calib.logger.debug("S045_Turn_Off_Main_CT_Neutral_CT : turn_on_break_pin : status : " + status); 
		Calib.logger.debug("S045_Turn_Off_Main_CT_Neutral_CT : turn_on_break_pin : Exit");
		return responseReturn;
	}
	...
	private Map<String,Object> turn_off_break_pin() {
		Calib.logger.debug("S045_Turn_Off_Main_CT_Neutral_CT : turn_off_break_pin : Entry");
		...
		if (portInfo != null) {
			...
			Calib.logger.debug("S045_Turn_Off_Main_CT_Neutral_CT : turn_off_break_pin : Output port not found");
		...
		Calib.logger.debug("S045_Turn_Off_Main_CT_Neutral_CT : turn_off_break_pin : status : " + status); 
		Calib.logger.debug("S045_Turn_Off_Main_CT_Neutral_CT : turn_off_break_pin : Exit");
		return responseReturn;
	}
	...
	public static void setCtResetRequest(boolean ctResetRequest) {
		S059_10_Turn_Off_Main_CT_Neutral_CT.ctResetRequest = ctResetRequest;
	}
	public static void setCtResetRequestAcknowledged(boolean ctResetRequestAcknowledged) {
		S059_10_Turn_Off_Main_CT_Neutral_CT.ctResetRequestAcknowledged = ctResetRequestAcknowledged;
	}
