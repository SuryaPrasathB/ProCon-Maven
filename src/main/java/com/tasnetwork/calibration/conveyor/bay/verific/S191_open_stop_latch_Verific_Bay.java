...
public class S191_open_stop_latch_Verific_Bay implements VerificTestBayState {
    ...
    public BayResponse handleRequest() {
        ...
        if (openStopLatch_Verific_Bay) {
            ...
            if (S044_Close_Run_Project.isVerificationTestCompleted()) {
                ...
                Verification.logger.info("S191_open_stop_latch_Verific_Bay : Stop Latch : palletsPassedVerificBay-1 : "
                        + palletsPassedVerificBay);
                /*
                 * }else{
                 * VerificationTestBay.logger.
                 * info("S191_open_stop_latch_Verific_Bay : Stop Latch Opened-hit1-A");
                 * }
                 */
            } else {
                palletsPassedVerificBay++; // REMOVE LATER
                Verification.logger.info("S191_open_stop_latch_Verific_Bay : Stop Latch : palletsPassedVerificBay-2 : "
                        + palletsPassedVerificBay);
            ...
            if (ProconFeatureEnable.MOTOR_CONTROL_ENABLE) {
                if (getPalletsPassedVerificBay() < 2) {
                    ...
                    responseReturn = bayUtils.set_motor_required(getMyBayKey(),
                            Constant_Motor_Requirement.VERIFIC_MOTOR_STA2_REQUIRED);
            ...
            Verification.logger
                    .info("S191_open_stop_latch_Verific_Bay : palletsPassedVerificBay : " + palletsPassedVerificBay);
    ...
    private Map<String, Object> open_StopLatch_Verific_Bay() {
        ...
        if (portInfo != null) {
            ...
            Verification.logger
                    .debug("S191_open_stop_latch_Verific_Bay : open_StopLatch_Verific_Bay : state : " + state);
            /*
            ...
            Verification.logger
                    .debug("S191_open_stop_latch_Verific_Bay : open_StopLatch_Verific_Bay : status : " + status);
        ...
        Verification.logger
                .debug("S191_open_stop_latch_Verific_Bay : verificBay_StopLatch_Status : status : " + status);
