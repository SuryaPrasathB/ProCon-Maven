...
public class S03_close_the_fingerTip_Latch implements VerificTestBayState {
    ...
    private Map<String, Object> close_FingerTipLatch_VerificBay() {
        ...
        if (portInfo != null) {
            ...
            Verification.logger
                    .debug("S03_close_the_fingerTip_Latch : close_FingerTipLatch_VerificBay : Output port not found");
        ...
        Verification.logger
                .debug("S03_close_the_fingerTip_Latch : close_FingerTipLatch_VerificBay : status : " + status);
        // ============================================================================================
