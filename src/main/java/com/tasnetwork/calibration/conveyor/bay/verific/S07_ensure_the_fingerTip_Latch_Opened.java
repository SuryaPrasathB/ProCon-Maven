    ...
    private Map<String, Object> verificBay_FingerTipLatch_Status() {
        ...
        if (portInfo != null) {
            ...
            Verification.logger.debug(
                    "S07_ensure_the_fingerTip_Latch_Opened : verificBay_FingerTipLatch_Status : Output port not found");
        ...
        Verification.logger
                .debug("S07_ensure_the_fingerTip_Latch_Opened : verificBay_FingerTipLatch_Status : state : " + state);
