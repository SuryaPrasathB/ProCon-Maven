...
public class S02_qR_Code_Scanning_of_Pallet_Bay2 implements STA_NoLoadTestBay2State {
	...
	public BayResponse handleRequest() {
		 ...
		 * String do_QR_Code_Scanning_Pallet_SctNltBay2 =
		 * (String)responseReturn.get("responseData");
		 * 
		 * String status = do_QR_Code_Scanning_Pallet_SctNltBay2; // Call the function
		 ...
		 * bayResponse.setErrorCode(ConvErrorCodeMapping.ERROR_CODE_SCT_NLT_BAY2_006);
		 * // Failure error code
		 * }
	...
	private Map<String, Object> do_QR_Code_Scanning_Pallet_SctNltBay2() {
		...
		terminalBayProfile = MySqlServiceManager.getTerminalProfileSettingService()
				.findByBayKey(ConstantConveyor.STA_NLD2_BAY_KEY);
		...
		StaNld_Bay2.logger
				.debug("S02_qR_Code_Scanning_of_Pallet : do_QR_Code_Scanning_Pallet_SctNltBay2 : status : " + status);
