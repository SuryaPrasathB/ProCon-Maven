...
public class S03_close_the_fingerTip_Latch_Bay2 implements STA_NoLoadTestBay2State {
    ...
    private Map<String, Object> close_FingerTipLatch_SctNltBay2() {
        ...
        if (portInfo != null) {
            ...
            StaNld_Bay2.logger
                    .debug("S03_close_the_fingerTip_Latch : close_FingerTipLatch_SctNltBay2 : Output port not found");
        ...
        StaNld_Bay2.logger
                .debug("S03_close_the_fingerTip_Latch : close_FingerTipLatch_SctNltBay2 : status : " + status);
        // ============================================================================================
