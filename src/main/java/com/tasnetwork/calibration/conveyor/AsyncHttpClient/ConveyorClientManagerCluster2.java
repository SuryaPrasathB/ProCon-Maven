...
public class ConveyorClientManagerCluster2 {
	...
	private static ConveyorClientManagerCluster2 instance;

	//private ConveyorClientManager instance;
	private ConveyorClientManagerCluster2() {
		// Private constructor to prevent direct instantiation
	}

	public static synchronized ConveyorClientManagerCluster2 getInstance() {
		if (instance == null) {
			instance = new ConveyorClientManagerCluster2();
		}
		return instance;
	}
	
/*	public  synchronized ConveyorClientManager getInstance(String inpClusterId) {
		if (instance == null) {
