...
public class ConveyorClientManager {
	...
	/*
	 * public static synchronized ConveyorClientManager getInstance(String
	 * clusterId) {
	 * return instances.computeIfAbsent(clusterId, k -> new
	...
	public static class ClusterUtils {
		...
		// private static volatile ConcurrentHashMap<String, Object> clusterLocks = new
		// ConcurrentHashMap<>();
	...
	/*
	 * public void getData(String deviceId, String bayId,String outputId,String
	 * outputValue){
	 * //setResponseReceived(false);
	...
	/*
	 * public void setBayData(String deviceId, String bayId,String outputId,String
	 * outputValue){
	 * //setResponseReceived(false);
	...
	/*
	 * public void setBayData(ClusterServer clusterServer,String deviceId, String
	 * bayId,String outputId,String outputValue){
	 * //setResponseReceived(false);
	 * getAsyncConvClient().setBayData(clusterServer, deviceId, bayId, outputId,
	 * outputValue);
	 * }
	 * 
	 * 
	 * 
	 * public void getBayData(ClusterServer clusterServer,String deviceId, String
	 * bayId,String outputId){
	 * //setResponseReceived(false);
	 * getAsyncConvClient().getBayData(clusterServer, deviceId, bayId, outputId);
	 * }
	 */

	// public synchronized void messageBayData(boolean setType, ClusterServer
	// clusterServer,String deviceId, String bayId,String outputId,String
	// outputValue) {
	// =========================
	// For Each Cluster
	// =========================
	public void messageBayData(boolean setType, ClusterServer clusterServer, String deviceId, String bayId,
			String outputId, String outputValue) {
		...
		while ((retryCount != 0) && (!messageProcessed) && (!BayUtils.isUserAborted())) {
			...
			synchronized (clusterLock) { // Lock based on clusterId
				ApplicationLauncher.logger
						.debug("messageBayData: Processing cluster: " + clusterId + " : outputId : " + outputId);
				...
				ApplicationLauncher.logger.debug(
						"messageBayData: Completed processing for cluster: " + clusterId + " : outputId : " + outputId);
			}
		}
	}
	...
	// =========================
	/*
	 * public void messageBayData(boolean setType, ClusterServer clusterServer,
	 * String deviceId, String bayId, String outputId, String outputValue) {
	 * ApplicationLauncher.logger.debug("messageBayData : Entry");
	 * int retryCount = 10;
	 * boolean messageProcessed = false;
	 * 
	 ...
	 * 
	 * while ((retryCount != 0) && (!messageProcessed) &&
	 * (!BayUtils.isUserAborted())) {
	 * retryCount--;
	 * ApplicationLauncher.logger.debug("messageBayData : retryCount: " + retryCount
	 * + " : " + outputId);
	 * 
	 * synchronized (bayLock) { // Synchronize on specific bayId lock
	 * ApplicationLauncher.logger.debug("messageBayData: : Processing bayId: " +
	 * bayId);
	 * 
	 * if (setType) {
	 * if (ProcalFeatureEnable.CONVEYOR_REST_CLIENT_ENABLED) {
	 * getRestConvClient().setBayData(clusterServer, deviceId, bayId, outputId,
	 * outputValue);
	 * } else {
	 * getAsyncConvClient().setBayData(clusterServer, deviceId, bayId, outputId,
	 * outputValue);
	 ...
	 * 
	 * ApplicationLauncher.logger.
	 * debug("messageBayData: : Completed processing for bayId: " + bayId);
	 * }
	 * }
	 * }
	 */
	...
	/*
	 * public void messageBayData(boolean setType, ClusterServer
	 * clusterServer,String deviceId, String bayId,String outputId,String
	 * outputValue) {
	 * ApplicationLauncher.logger.debug("messageBayData : Entry");
	 * int retryCount =10;
	 ...
	 * + " : " + outputId);
	 * 
	 * while( (BayUtils.ftBayMessageSenderSemLocked) ){//&&
	 * (!BayUtils.isUserAborted())){
	 * ApplicationLauncher.logger.
	 * debug("messageBayData: : awaiting for ftBayMessageSenderSemLocked1 :" +
	 * outputId);
	 ...
	 * }
	 * ApplicationLauncher.logger.
	 * debug("messageBayData: : awaiting Exit for ftBayMessageSenderSemLocked2 :" +
	 * outputId);
	 * //synchronized(this) {
	 * if(!BayUtils.ftBayMessageSenderSemLocked){
	 * BayUtils.ftBayMessageSenderSemLocked = true;
	 * ApplicationLauncher.logger.
	 * debug("messageBayData: : ftBayMessageSenderSemLocked : locked: " + outputId
	 * );
	 * if(setType) {
	 * if(ProcalFeatureEnable.CONVEYOR_REST_CLIENT_ENABLED) {
	 * getRestConvClient().setBayData(clusterServer, deviceId, bayId, outputId,
	 ...
	 * ApplicationLauncher.logger.
	 * debug("messageBayData: : ftBayMessageSenderSemLocked : unlocked : " +outputId
	 * );
	 * //}
	 * }else{
	 * ApplicationLauncher.logger.
	 * debug("messageBayData: :  still locked ftBayMessageSenderSemLocked :" +
	 * outputId);
	 * }
	 * }
	 * 
