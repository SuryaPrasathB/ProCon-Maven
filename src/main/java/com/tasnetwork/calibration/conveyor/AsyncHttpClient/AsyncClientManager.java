...
/*				.addParameter("primaryCommand", "*idn?\r\n")
		...
		/*		.addParameter("occtime", occur_time_in_sec)
				...
				.addParameter("r_ManageResistanceIndexList", rPhaseTestSeqSelectedLoadIndexListInStr)
				.addParameter("y_ManageResistanceIndexList", yPhaseTestSeqSelectedLoadIndexListInStr)
				.addParameter("b_ManageResistanceIndexList", bPhaseTestSeqSelectedLoadIndexListInStr)
...
/*		if(ConstantProTamp.PROTAMP_SINGLE_PHASE){
	...
	public void  tamper3PhaseManageLoadResistanceBank(String tp_ID,String rPhaseManageResistanceIndex,String yPhaseManageResistanceIndex,
		...
		if(ConstantProTamp.PROTAMP_SINGLE_PHASE){
			testPointID = testPointID.substring(1);
			ApplicationLauncher.logger.info("tamper3PhaseManageLoadResistanceBank :ManualMode: testPointID :"+ testPointID);
		}
