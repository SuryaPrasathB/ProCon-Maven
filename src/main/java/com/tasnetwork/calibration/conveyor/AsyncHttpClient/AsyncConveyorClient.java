...
public class AsyncConveyorClient  {
	...
	public void setData(String deviceId, String bayId, String outputId, String outputValue) {
    	...
    	//ApplicationLauncher.logger.info("AsyncConveyorClient: TARGET_URL: " + TARGET_URL);
    			...
    			public Response onCompleted(Response response) throws IOException {
    				...
    				if(response.getStatusCode() == 200){
    					...
    					try {
							...
							// TODO Auto-generated catch block
							e.printStackTrace();
							ApplicationLauncher.logger.error("AsyncConveyorClient: setData: ParseException : "+e.getMessage());
						}
...
/*	public void setBayData( String deviceId, String bayId, String outputId, String outputValue) {
    	...
    	try {
    		...
    		// TODO Auto-generated catch block
    		e1.printStackTrace();
    		ApplicationLauncher.logger.error("AsyncConveyorClient: setData : IOException:" + e1.getMessage());
    	}
    		...
    		f = c.prepareRequest(request).execute(new AsyncCompletionHandler<Response>() {
    			...
    			public Response onCompleted(Response response) throws IOException {
    				...
    				if(response.getStatusCode() == 200){
    					...
    					ApplicationLauncher.logger.debug("getBayData: getRestApiClusterResponseBodyData : "+getRestApiClusterResponseBodyData().toString());
    					ApplicationLauncher.logger.debug("getBayData: getStatusCode-2 :"+myCurrentAPIResponse.getStatusCode());
    			...
    			@Override
    			public void onThrowable(Throwable t) {
    				ApplicationLauncher.logger.info("getBayData:  onThrowable:"+t.getMessage() + " : endPoint: " + request.getUrl());
